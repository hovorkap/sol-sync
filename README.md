# SkolaOnline CalDAV Sync — Home Assistant Add-on Repository

This repository hosts the **SkolaOnline CalDAV Sync** Home Assistant add-on.
...
4. Find and install **SkolaOnline CalDAV Sync**
